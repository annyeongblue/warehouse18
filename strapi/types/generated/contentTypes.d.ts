...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_1s: Schema.Attribute.Relation<'oneToMany', 'api::user-1.user-1'>;
  };
}
...
export interface ApiAuthAuth extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    auth_name: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiBorrowDetailBorrowDetail
  extends Struct.CollectionTypeSchema {
...
export interface ApiBorrowBorrow extends Struct.CollectionTypeSchema {
...
export interface ApiExportDetailExportDetail
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::export-detail.export-detail'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    qty: Schema.Attribute.Integer;
...
export interface ApiExportExport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date;
    export_approver: Schema.Attribute.Relation<
      'manyToOne',
      'api::user-1.user-1'
    >;
    export_details: Schema.Attribute.Relation<
      'oneToMany',
      'api::export-detail.export-detail'
    >;
    export_user: Schema.Attribute.Relation<'manyToOne', 'api::user-1.user-1'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::export.export'
...
export interface ApiImportDetailImportDetail
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    import: Schema.Attribute.Relation<'manyToOne', 'api::import.import'>;
    item: Schema.Attribute.Relation<'manyToOne', 'api::item.item'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiImportImport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date;
    import_details: Schema.Attribute.Relation<
      'oneToMany',
      'api::import-detail.import-detail'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiItemInformationItemInformation
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    repair_details: Schema.Attribute.Relation<
      'oneToMany',
      'api::repair-detail.repair-detail'
    >;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    date: Schema.Attribute.Date;
    description: Schema.Attribute.String;
    import: Schema.Attribute.Relation<'oneToOne', 'api::import.import'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiRepairDetailRepairDetail
  extends Struct.CollectionTypeSchema {
...
export interface ApiRepairRepair extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    reapir_approver: Schema.Attribute.Relation<
      'manyToOne',
      'api::user-1.user-1'
    >;
    repair_date: Schema.Attribute.Date;
    repair_description: Schema.Attribute.String;
    repair_details: Schema.Attribute.Relation<
      'oneToMany',
      'api::repair-detail.repair-detail'
    >;
    repair_user: Schema.Attribute.Relation<'manyToOne', 'api::user-1.user-1'>;
    return_date: Schema.Attribute.Date;
    statas: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiUser1User1 extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    approver: Schema.Attribute.Relation<'oneToMany', 'api::borrow.borrow'>;
    approver_reapir: Schema.Attribute.Relation<
      'oneToMany',
      'api::repair.repair'
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
    ex_approver: Schema.Attribute.Relation<'oneToMany', 'api::export.export'>;
    exports: Schema.Attribute.Relation<'oneToMany', 'api::export.export'>;
    firstname: Schema.Attribute.String;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_repair: Schema.Attribute.Relation<'oneToMany', 'api::repair.repair'>;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::borrow-detail.borrow-detail': ApiBorrowDetailBorrowDetail;
      'api::borrow.borrow': ApiBorrowBorrow;
      'api::brand.brand': ApiBrandBrand;
      'api::category.category': ApiCategoryCategory;
      'api::export-detail.export-detail': ApiExportDetailExportDetail;
      'api::export.export': ApiExportExport;
      ...
      'api::repair-detail.repair-detail': ApiRepairDetailRepairDetail;
      'api::repair.repair': ApiRepairRepair;
      'api::test.test': ApiTestTest;
      'api::unit.unit': ApiUnitUnit;
      'api::user-1.user-1': ApiUser1User1;
